...
/**
 * Analysis:
 *   1. To include the case target is left or right, while statement must be (left<=right)
 *   2. Check the target is on the opposite side of the rotated pivot, such that the array is fully in ascending order.
 *   3. 
 * 
 */
